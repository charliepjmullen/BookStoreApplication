	...
	<tr>
		...
		<c:forEach var="o" items="${booksList}" varStatus="loopStatus">
			<tr>
				...
				<!-- <td width="3.5%" height="50"><a href="shoppingCart/${booksList[loopStatus.index].id}" >Add Book to Shopping Cart</a></td> -->
				<!-- <td width="3.5%" height="50"><a href="javascript:addBook();" >Add Book to Shopping Cart</a></td> -->
				<td><a href="<c:url value='/shoppingcart/${o.id}' />">
   							 Add Book to Shopping Cart
 					 </a>
 			    </td>

				<td  width="3.5%"><c:out value="${booksList[loopStatus.index]}" /></td>				   
             </tr>
		</c:forEach>
